...
volatile uint16_t volume = 3;          // (0 - 1000)
...
void Update_Melody()
{
    ...
    if(current_tone_number == melody_tone_count && !_start_game && !active_buzzer)
    {
    	current_tone_number = 0;
    }
    else if(_start_game || active_buzzer)
    {
    	current_tone_number = melody_tone_count + 1;
    }
